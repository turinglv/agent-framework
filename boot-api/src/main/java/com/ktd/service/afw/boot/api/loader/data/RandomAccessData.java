...
package com.ktd.service.afw.boot.api.loader.data;
...
/**
 * Interface that provides read-only random access to some underlying data. Implementations must
 * allow concurrent reads in a thread-safe manner.
 *
 * @author Phillip Webb
 */
public interface RandomAccessData {
  ...
  /**
   * Returns an {@link InputStream} that can be used to read the underlying data. The caller is
   * responsible close the underlying stream.
   *
