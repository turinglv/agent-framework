...
public class StaticMethodEnhancer {
    ...
    public StaticMethodEnhancer(String staticMethodsAroundInjectorClassName) {
        this.staticMethodsAroundInjectorClassName = staticMethodsAroundInjectorClassName;
    }

    @RuntimeType
    public Object enhance(@Origin Class<?> clazz, @AllArguments Object[] allArguments, @Origin Method method, @SuperCall Callable<?> zuper) throws Throwable {
