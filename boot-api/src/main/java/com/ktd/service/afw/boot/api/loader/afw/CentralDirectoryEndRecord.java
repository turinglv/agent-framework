...
class CentralDirectoryEndRecord {
  ...
  /**
   * Create a new {@link CentralDirectoryEndRecord} instance from the specified {@link
   * RandomAccessData}, searching backwards from the end until a valid block is located.
   *
  ...
  /**
   * Returns the location in the data that the archive actually starts. For most files the archive
   * data will start at 0, however, it is possible to have prefixed bytes (often used for startup
   * scripts) at the beginning of the data.
   *
   * @param data the source data
