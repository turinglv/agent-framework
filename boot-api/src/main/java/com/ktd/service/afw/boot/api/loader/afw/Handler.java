 ...
 * @see ProtocolHandlerRegister#registerUrlProtocolHandler()
 */
public class Handler extends URLStreamHandler {
  ...
  public static final String AFW_PROTOCOL = "afw:";
  ...
  /**
   * Set if a generic static exception can be thrown when a URL cannot be connected. This
   * optimization is used during class loading to save creating lots of exceptions which are then
   * swallowed.
   *
  ...
  protected void parseURL(URL context, String spec, int start, int limit) {
    if (spec.regionMatches(true, 0, AFW_PROTOCOL, 0, AFW_PROTOCOL.length())) {
  ...
  private void setFile(URL context, String file) {
    setURL(context, AFW_PROTOCOL, null, -1, null, null, normalize(file), null, null);
  }
