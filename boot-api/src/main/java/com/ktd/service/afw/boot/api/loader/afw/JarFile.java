...
import com.ktd.service.afw.boot.api.loader.data.RandomAccessDataFile;
import java.io.File;
...
/**
 * Extended variant of {@link java.util.jar.JarFile} that behaves in the same way but offers the
...
public class JarFile extends java.util.jar.JarFile {
  ...
  /**
   * Private constructor used to create a new {@link JarFile} either directly or from a nested
   * entry.
   *
  ...
  /**
   * Return a URL that can be used to access this JAR file. NOTE: the specified URL cannot be
   * serialized and or cloned.
   *
   * @return the URL
