...
/**
 * Simple wrapper around a byte array that represents an ASCII. Used for performance reasons to save
 * constructing Strings for ZIP data.
 *
 * @author Phillip Webb
...
final class AsciiBytes {
  ...
  /**
   * Create a new {@link AsciiBytes} from the specified bytes. NOTE: underlying bytes are not
   * expected to change.
   *
