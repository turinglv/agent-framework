...
public final class CacheBuilder<K, V> {
   ...
   *
   * <p>Note that while this return type is {@code CacheBuilder<Object, Object>}, type parameters
   * on the {@link #build} methods allow you to create a cache of any key and value type desired.
   */
   ...
   *
   * <p>Note that the cache <b>may evict an entry before this limit is exceeded</b>. For example,
   * in the current implementation, when {@code concurrencyLevel} is greater than {@code 1}, each
   ...
   *
   * <p>If {@code maximumSize} is zero, elements will be evicted immediately after being loaded
   ...
   * a cache whose key or value type is incompatible with the weigher, you will likely experience a
   ...
   * WeakReference} (by default, strong references are used).
   *
   * <p>Weak values will be garbage collected once they are weakly reachable. This makes them a
   * poor candidate for caching; consider {@link #softValues} instead.
   *
   ...
   * in the class javadoc.
   *
   * <p>If you can represent the duration as a {@link java.time.Duration} (which should be
   * preferred when feasible), use {@link #expireAfterWrite(Duration)} instead.
   *
   * @param duration the length of time after an entry is created that it should be automatically
   *                 removed
   ...
   *
   * <p>If you can represent the duration as a {@link java.time.Duration} (which should be
   * preferred when feasible), use {@link #expireAfterAccess(Duration)} instead.
   *
   * @param duration the length of time after an entry is last accessed that it should be
   *                 automatically removed
   * @param unit     the unit that {@code duration} is expressed in
   ...
   *
   * <p>If you can represent the duration as a {@link java.time.Duration} (which should be
   * preferred when feasible), use {@link #refreshAfterWrite(Duration)} instead.
   *
   * @param duration the length of time after an entry is created that it should be considered
   *                 stale, and thus eligible for refresh
   * @param unit     the unit that {@code duration} is expressed in
  ...
  <K1 extends K, V1 extends V> RemovalListener<K1, V1> getRemovalListener() {
    return (RemovalListener<K1, V1>) MoreObjects.firstNonNull(removalListener,
  ...
  public String toString() {
    return "CacheBuilder{" + "strictParsing=" + strictParsing + ", initialCapacity="
        + initialCapacity + ", concurrencyLevel=" + concurrencyLevel + ", maximumSize="
        + maximumSize + ", maximumWeight=" + maximumWeight + ", keyStrength=" + keyStrength
        + ", valueStrength=" + valueStrength + ", expireAfterWriteNanos=" + expireAfterWriteNanos
        + ", expireAfterAccessNanos=" + expireAfterAccessNanos + ", refreshNanos=" + refreshNanos
        + ", ticker=" + ticker + '}';
  }
