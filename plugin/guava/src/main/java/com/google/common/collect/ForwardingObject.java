...
/**
 * An abstract base class for implementing the <a href="http://en.wikipedia.org/wiki/Decorator_pattern">decorator
 * pattern</a>. The {@link #delegate()} method must be overridden to return the instance being
 * decorated.
 *
