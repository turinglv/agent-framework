...
public abstract class AbstractCache<K, V> implements Cache<K, V> {
  ...
  public static final class SimpleStatsCounter implements StatsCounter {
    ...
    private final LongAdder hitCount = LongAdderSupplier.create();
    private final LongAdder missCount = LongAdderSupplier.create();
    private final LongAdder loadSuccessCount = LongAdderSupplier.create();
    private final LongAdder loadExceptionCount = LongAdderSupplier.create();
    private final LongAdder totalLoadTime = LongAdderSupplier.create();
    private final LongAdder evictionCount = LongAdderSupplier.create();
