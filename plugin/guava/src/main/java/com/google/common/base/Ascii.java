...
public final class Ascii {
   ...
   * to the first printing position on the same printing line. (Applicable also to display
   * devices.)
   *
   * @since 8.0
   */
  ...
  public static String truncate(CharSequence seq, int maxLength, String truncationIndicator) {
    ...
    return new StringBuilder(maxLength).append(seq, 0, truncationLength).append(truncationIndicator)
        .toString();
  }
   ...
   * 'a'/'A' returns 0 and 'z'/'Z' returns 25. Non-alpha characters return a value of 26 or
   * greater.
   */
