 ...
 * two separate characters. {@link #countIn} counts each supplementary character as 2 {@code
 * char}s.
 *
...
public abstract class CharMatcher implements Predicate<Character> {
   ...
   *
   * @deprecated Use {@link #whitespace()} instead. This constant is scheduled to be removed in June
   * 2018.
   */
   ...
   *
   * @since 2.0
   * @deprecated Use {@link #breakingWhitespace()} instead. This constant is scheduled to be removed
   * in June 2018.
   */
   ...
   * Unicode</a>. If you only care to match ASCII digits, you can use {@code inRange('0', '9')}.
   *
   * @deprecated Many digits are supplementary characters; see the class documentation. If you need
   * to use this, use {@link #digit()} instead. This .   constant is scheduled to be removed in June
   * 2018.
   */
  @Deprecated
   ...
   *
   * @deprecated Many digits are supplementary characters; see the class documentation. If you need
   * to use this, use {@link #javaDigit()} instead. This constant is scheduled to be removed in June
   * 2018.
   */
  @Deprecated
   ...
   *
   * @deprecated Most letters are supplementary characters; see the class documentation. If you need
   * to use this, use {@link #javaLetter()} instead. This constant is scheduled to be removed in
   * June 2018.
   */
  @Deprecated
   ...
   * If you need to use this, use {@link #javaLetterOrDigit()} instead. This constant is scheduled
   ...
   *
   * @deprecated Some uppercase letters are supplementary characters; see the class documentation.
   * If you need to use this, use {@link #javaUpperCase()} instead. This constant is scheduled to be
   ...
   *
   * @deprecated Some lowercase letters are supplementary characters; see the class documentation.
   * If you need to use this, use {@link #javaLowerCase()} instead. This constant is scheduled to be
   * removed in June 2018.
   */
  @Deprecated
   ...
   *
   * @deprecated Use {@link #javaIsoControl()} instead. This constant is scheduled to be removed in
   * June 2018.
   */
  @Deprecated
   ...
   * documentation. If you need to use this, use {@link #invisible()} instead. This constant is
   ...
   * keep it up to date.
   *
   * @deprecated Many such characters are supplementary characters; see the class documentation. If
   * you need to use this, use {@link #singleWidth()} instead. This constant is scheduled to be
   * removed in June 2018.
   */
  @Deprecated
   ...
   *
   * @deprecated Use {@link #any()} instead. This constant is scheduled to be removed in June 2018.
   */
  @Deprecated
   ...
   *
   * @deprecated Use {@link #none()} instead. This constant is scheduled to be removed in June 2018.
   */
  @Deprecated
  ...
  /**
   * Determines whether a character is a BMP digit according to <a href="http://unicode.org/cldr/utility/list-unicodeset.jsp?a=%5Cp%7Bdigit%7D">Unicode</a>.
  ...
  private static boolean isSmall(int totalCharacters, int tableLength) {
    return totalCharacters <= SmallCharMatcher.MAX_SIZE && tableLength > (totalCharacters * 4
        * Character.SIZE);
  ...
  CharMatcher precomputedInternal() {
    ...
    if (totalCharacters * 2 <= DISTINCT_CHARS) {
      ...
      String negatedDescription = description.endsWith(suffix) ? description.substring(0,
          description.length() - suffix.length()) : description + suffix;
  ...
  private static final class InRange extends FastMatcher {
    ...
    @Override
    public String toString() {
      return "CharMatcher.inRange('" + showCharacter(startInclusive) + "', '" + showCharacter(
          endInclusive) + "')";
    }
  }
