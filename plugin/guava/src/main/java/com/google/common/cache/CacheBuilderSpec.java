...
public final class CacheBuilderSpec {
   ...
   */
  private static final Map<String, ValueParser> VALUE_PARSERS = ImmutableMap.<String, ValueParser>builder()
  ...
  public String toString() {
    return "CacheBuilderSpec{" + "specification='" + specification + '\'' + '}';
  }
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    return Objects.equal(initialCapacity, that.initialCapacity) && Objects.equal(maximumSize,
        that.maximumSize) && Objects.equal(maximumWeight, that.maximumWeight) && Objects.equal(
        concurrencyLevel, that.concurrencyLevel) && Objects.equal(keyStrength, that.keyStrength)
        && Objects.equal(valueStrength, that.valueStrength) && Objects.equal(recordStats,
        that.recordStats) && Objects.equal(
        durationInNanos(writeExpirationDuration, writeExpirationTimeUnit),
    ...
    public void parse(CacheBuilderSpec spec, String key, String value) {
      ...
      try {
        ...
        switch (lastChar) {
          ...
          default:
            throw new IllegalArgumentException(
                format("key %s invalid format.  was %s, must end with one of [dDhHmMsS]", key,
                    value));
        }
