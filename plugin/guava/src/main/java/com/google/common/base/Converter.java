...
public abstract class Converter<A, B> implements Function<A, B> {
   ...
   *                                       consider a {@code Converter<Chicken, ChickenNugget>}),
   *                                       then this is not logically a {@code Converter} at all,
   *                                       and should just implement {@link Function}.
   */
   ...
   *
   * <p>The returned converter is serializable if {@code this} converter and {@code
   * secondConverter} are.
   */
   ...
   * for all {@code a} of type {@code A} (and similarly for {@code reverse}). Note that a {@code
   * false} result from this method does not imply that the converters are known <i>not</i> to be
   * interchangeable.
   */
  @Override
  ...
  private static final class ReverseConverter<A, B> extends Converter<B, A> implements
      Serializable {
  ...
  private static final class ConverterComposition<A, B, C> extends Converter<A, C> implements
      Serializable {
  ...
  private static final class FunctionBasedConverter<A, B> extends Converter<A, B> implements
      Serializable {
    ...
    public boolean equals(@Nullable Object object) {
      if (object instanceof FunctionBasedConverter) {
        ...
        return this.forwardFunction.equals(that.forwardFunction) && this.backwardFunction.equals(
