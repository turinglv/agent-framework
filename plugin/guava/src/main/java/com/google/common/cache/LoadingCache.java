...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   *
   * <p>Caches loaded by a {@link CacheLoader} will call {@link CacheLoader#load} to load new
   * values into the cache. Newly loaded values are added to the cache using {@code
   ...
   *                                     ({@code ExecutionException} is thrown <a
   *                                     href="https://github.com/google/guava/wiki/CachesExplained#interruption">even
   *                                     if computation was interrupted by an {@code
   ...
   * {@inheritDoc}
   *
   * <p><b>Note that although the view <i>is</i> modifiable, no method on the returned map will
   * ever cause entries to be automatically loaded.</b>
   */
  @Override
