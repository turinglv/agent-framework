...
public final class Ints {
  ...
  /**
   * Returns a comparator that compares two {@code int} arrays <a href="http://en.wikipedia.org/wiki/Lexicographical_order">lexicographically</a>.
   ...
   * exclusive. This is equivalent to {@code Collections.reverse(Ints.asList(array).subList(fromIndex,
   * toIndex))}, but is likely to be more efficient.
   *
  ...
  private static final class IntConverter extends Converter<String, Integer> implements
      Serializable {
